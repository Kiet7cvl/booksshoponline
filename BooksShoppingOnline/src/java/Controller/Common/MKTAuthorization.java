...
public class MKTAuthorization implements Filter {
    ...
    public MKTAuthorization() {
    } 

    private void doBeforeProcessing(ServletRequest request, ServletResponse response)
	throws IOException, ServletException {
	if (debug) log("MKTAuthorization:DoBeforeProcessing");
	...
	*/
	...
	throws IOException, ServletException {
	if (debug) log("MKTAuthorization:DoAfterProcessing");
	...
	*/
	...
	if (debug) log("MKTAuthorization:doFilter()");
	...
	if (filterConfig != null) {
	    if (debug) { 
		log("MKTAuthorization:Initializing filter");
	    }
	}
    }
	...
	if (filterConfig == null) return ("MKTAuthorization()");
	StringBuffer sb = new StringBuffer("MKTAuthorization(");
