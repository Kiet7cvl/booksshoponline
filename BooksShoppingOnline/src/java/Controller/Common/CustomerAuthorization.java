...
//	if (debug) log("CustomerAuthorization:DoBeforeProcessing");
//
...
//	throws IOException, ServletException {
//	if (debug) log("CustomerAuthorization:DoAfterProcessing");
//
...
//	throws IOException, ServletException {
//
//	if (debug) log("CustomerAuthorization:doFilter()");
//
...
//	    if (debug) { 
//		log("CustomerAuthorization:Initializing filter");
//	    }
//	}
//    }
//
...
//	if (filterConfig == null) return ("CustomerAuthorization()");
//	StringBuffer sb = new StringBuffer("CustomerAuthorization(");
