                                                    ...
                                                    <div class="row invoice mt-4 " style="padding: 10px;margin-left: 10px">
                                                        ...
                                                        <div class="col">
                                                            ...
                                                            <c:if test="${sessionScope.us.role_Id == 4}">
                                                                ...
                                                                <p class="mb-1 cus-fontsize"style="margin-top: 10px;float: inherit"> Người bán hàng  :</p>

                                                                    <select class="form-control"  name="salerId" aria-label="Default select example" style="width: auto;margin-top: 10px;">
